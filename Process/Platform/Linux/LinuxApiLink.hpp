...
public:
	...
	uint32_t getProcessIDByName(const std::string& name) const = 0;
	std::vector<uint32_t> getProcessIDsByName(const std::string& name) const = 0;
	uint32_t getProcessIDByWindowName(const std::string& windowTitle) const = 0;
	std::vector<uint32_t> getProcessIDsByWindowName(const std::string& windowTitle) const = 0;
